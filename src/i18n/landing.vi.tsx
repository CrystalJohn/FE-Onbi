...
const vi: LandingContent = {
  ...
  blog: {
    ...
    placeholders: [
      { id: 2, category: 'Phương pháp học', title: 'Rèn Kỹ Năng Tự Học Cho Con: Ba Mẹ Cần Làm Gì Khi Không Thể Luôn Ở Bên?', excerpt: 'Rèn kỹ năng tự học cho con tiểu học đúng cách — 5 bước khoa học giúp trẻ tự giác ngồi vào bàn, tập trung đúng giờ mà ba mẹ không cần nhắc mỗi ngày.', author: 'Đội ngũ OnBi', date: '06/2026', href: '/blog/ren-ky-nang-tu-hoc-cho-tre-tieu-hoc', image: '/blog/blog-2/image-1.jpg', imageAlt: 'Góc học tập gọn gàng giúp trẻ tiểu học hình thành kỹ năng tự học hiệu quả tại nhà' },
      { id: 3, category: 'Kinh nghiệm nuôi dạy con', title: 'Con Không Chịu Học Phải Làm Sao? Đây Là Câu Trả Lời Ba Mẹ Cần Ngay Hôm Nay', excerpt: 'Con không chịu học phải làm sao? Tìm hiểu ngay 6 nguyên nhân thật sự khiến trẻ lười học và giải pháp giúp con tự giác học bài mà không cần ba mẹ nhắc mỗi ngày.', author: 'Đội ngũ OnBi', date: '24/06/2026', href: '/blog/con-khong-chiu-hoc-phai-lam-sao', image: '/blog/blog-3/image-2.jpg', imageAlt: 'Trẻ tiểu học mất tập trung khi tự học một mình tại nhà' },
    ],
  },
};
