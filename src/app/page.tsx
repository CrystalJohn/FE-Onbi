          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            >
              ...
              <div className="hidden md:block absolute inset-0 z-0 select-none pointer-events-none">
                ...
                <div className={`absolute inset-y-0 right-0 bg-gradient-to-l from-[#f3f8fe] via-[#f3f8fe]/95 to-transparent ${language === 'vi' ? 'w-[38%]' : 'w-[45%]'}`} />
              </div>
              ...
              <div className="relative z-10 grid grid-cols-1 md:grid-cols-12 w-full h-full min-h-[400px] md:min-h-[480px]">
                ...
                <div className="col-span-1 md:col-span-5 flex flex-col items-center md:items-end justify-start pt-6 md:pt-10 p-6 md:p-8 bg-white md:bg-transparent rounded-3xl md:rounded-none z-10 text-center">
                  ...
                  <div className="w-full flex flex-col items-center md:max-w-[280px] md:mr-4">
                    ...
                    <div className="hidden md:block text-center mb-2">
                      ...
                      <p className="text-[11px] text-slate-500 max-w-[240px] mx-auto mt-1.5 leading-relaxed font-medium">
