...
function DropdownMenuSubTrigger({
  ...
  return (
    <DropdownMenuPrimitive.SubTrigger asChild disabled={disabled} textValue={textValue}>
      <motion.div ref={highlightedRef} data-slot="dropdown-menu-sub-trigger" data-disabled={disabled} {...props} />
    ...
    <AnimatePresence>
      {isOpen && (
        <DropdownMenuPortal forceMount container={container}>
          <DropdownMenuPrimitive.SubContent forceMount asChild loop={loop} onEscapeKeyDown={onEscapeKeyDown} onPointerDownOutside={onPointerDownOutside} onFocusOutside={onFocusOutside} onInteractOutside={onInteractOutside} sideOffset={sideOffset} alignOffset={alignOffset} avoidCollisions={avoidCollisions} collisionBoundary={collisionBoundary} collisionPadding={collisionPadding} arrowPadding={arrowPadding} sticky={sticky} hideWhenDetached={hideWhenDetached}>
...
function DropdownMenuItem({
  ...
  return (
    <DropdownMenuPrimitive.Item asChild disabled={disabled} onSelect={onSelect} textValue={textValue}>
      <motion.div ref={highlightedRef} data-slot="dropdown-menu-item" data-disabled={disabled} {...props} />
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <DropdownMenuPrimitive.CheckboxItem asChild checked={checked} onCheckedChange={onCheckedChange} disabled={disabled} onSelect={onSelect} textValue={textValue}>
      <motion.div ref={highlightedRef} data-slot="dropdown-menu-checkbox-item" data-disabled={disabled} {...props} />
...
function DropdownMenuRadioItem({
  ...
  return (
    <DropdownMenuPrimitive.RadioItem asChild value={value} disabled={disabled} onSelect={onSelect} textValue={textValue}>
      <motion.div ref={highlightedRef} data-slot="dropdown-menu-radio-item" data-disabled={disabled} {...props} />
...
function DropdownMenuItemIndicator(props: DropdownMenuItemIndicatorProps) {
  return (
    <DropdownMenuPrimitive.ItemIndicator asChild data-slot="dropdown-menu-item-indicator">
      <motion.div {...props} />
